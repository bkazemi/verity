...
Without one, serve `node_modules/@bkazemi/verity/dist/verity.js` yourself, or load it from a CDN such as `https://cdn.jsdelivr.net/npm/@bkazemi/verity@0.0.1/dist/verity.js`. The script defines a global `Verity`.
...
```html
<script src="https://cdn.jsdelivr.net/npm/@bkazemi/verity@0.0.1/dist/verity.js" defer></script>
<verity-badge
